...
type GetHealthScoreFleet503ResponseHeaders struct {
	RetryAfter int
}

type GetHealthScoreFleet503JSONResponse struct {
	Body    ErrorMessage
	Headers GetHealthScoreFleet503ResponseHeaders
}

func (response GetHealthScoreFleet503JSONResponse) VisitGetHealthScoreFleetResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
