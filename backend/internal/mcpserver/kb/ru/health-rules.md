...
во все индексы (bloat). Снизить fillfactor (70–90%) для горячих таблиц, чьи
UPDATE не меняют индексированные колонки.
...
старых миграций — проверить намеренность.

### stale_planner_stats
Таблицы, изменившиеся >50% с последнего ANALYZE и не анализировавшиеся >суток.
LOW ≥3, MED ≥5, HIGH ≥10. Вероятны плохие планы: ANALYZE или снизить
