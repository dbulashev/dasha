...
любая ошибка контрольных сумм, у sequence осталось меньше 5% значений,
диск хоста ≥90%.
...
точки и те же границы, где `schema_lint` даёт notice/warning/error, и они
сдвигаются вместе при настройке sequence_thresholds. Данные берутся из метрик,
если настроен источник, иначе из обхода каталога schema lint. Расширить
