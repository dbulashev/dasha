...
type Repository interface {
	...
	GetIndexesUnused(ctx context.Context, clusterName, instanceName, databaseName string, limit, offset int) ([]dto.IndexUnused, error)
	GetIndexesUnusedAllHosts(ctx context.Context, clusterName, databaseName string, limit, offset int) ([]dto.IndexUnused, error)
