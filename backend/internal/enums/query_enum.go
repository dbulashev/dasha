...
const (
	...
	QueryCommonHealthScoreHorizonBlockingSessions Query = "common/health_score_horizon_blocking_sessions"
	// QueryCommonHealthScoreLowHotUpdateTables is a Query of type common/health_score_low_hot_update_tables.
	QueryCommonHealthScoreLowHotUpdateTables Query = "common/health_score_low_hot_update_tables"
	...
	// QueryCommonHealthScoreTablesAutovacuumOff is a Query of type common/health_score_tables_autovacuum_off.
	QueryCommonHealthScoreTablesAutovacuumOff Query = "common/health_score_tables_autovacuum_off"
	// QueryCommonHealthScoreXidWraparoundDatabases is a Query of type common/health_score_xid_wraparound_databases.
	QueryCommonHealthScoreXidWraparoundDatabases Query = "common/health_score_xid_wraparound_databases"
	...
	// QueryConnectionsWaitEvents is a Query of type connections/wait_events.
	QueryConnectionsWaitEvents Query = "connections/wait_events"
	...
	// QueryDatabaseHealth is a Query of type database/health.
	QueryDatabaseHealth Query = "database/health"
	...
	// QueryIndexAdvisorColumns is a Query of type index_advisor/columns.
	QueryIndexAdvisorColumns Query = "index_advisor/columns"
	// QueryIndexAdvisorIndexes is a Query of type index_advisor/indexes.
	QueryIndexAdvisorIndexes Query = "index_advisor/indexes"
	// QueryIndexAdvisorRelations is a Query of type index_advisor/relations.
	QueryIndexAdvisorRelations Query = "index_advisor/relations"
	// QueryIndexAdvisorWorkload is a Query of type index_advisor/workload.
	QueryIndexAdvisorWorkload Query = "index_advisor/workload"
	// QueryIndexAdvisorWrites is a Query of type index_advisor/writes.
	QueryIndexAdvisorWrites Query = "index_advisor/writes"
	...
	// QuerySettingsPlanLogSettings is a Query of type settings/plan_log_settings.
	QuerySettingsPlanLogSettings Query = "settings/plan_log_settings"
	...
	QueryTablesDescribeBloat Query = "tables/describe_bloat"
	...
	// QueryTablesDescribePartitions is a Query of type tables/describe_partitions.
	...
	// QueryTablesPgstattupleAvailable is a Query of type tables/pgstattuple_available.
	QueryTablesPgstattupleAvailable Query = "tables/pgstattuple_available"
...
var _QueryNames = []string{
	...
	string(QueryCommonHealthScoreTablesAutovacuumOff),
	string(QueryCommonHealthScoreXidWraparoundDatabases),
	...
	string(QueryConnectionsWaitEvents),
	string(QueryConstraintsInvalidConstraints),
	string(QueryDatabaseHealth),
	...
	string(QueryIndexAdvisorColumns),
	string(QueryIndexAdvisorIndexes),
	string(QueryIndexAdvisorRelations),
	string(QueryIndexAdvisorWorkload),
	string(QueryIndexAdvisorWrites),
	...
	string(QuerySettingsPlanLogSettings),
...
func QueryValues() []Query {
	return []Query{
		...
		QueryCommonHealthScoreTablesAutovacuumOff,
		QueryCommonHealthScoreXidWraparoundDatabases,
		...
		QueryIndexAdvisorColumns,
		QueryIndexAdvisorIndexes,
		QueryIndexAdvisorRelations,
		QueryIndexAdvisorWorkload,
		QueryIndexAdvisorWrites,
...
var _QueryValue = map[string]Query{
	...
	"common/health_score_tables_autovacuum_off":     QueryCommonHealthScoreTablesAutovacuumOff,
	"common/health_score_xid_wraparound_databases":  QueryCommonHealthScoreXidWraparoundDatabases,
	...
	"connections/wait_events":                       QueryConnectionsWaitEvents,
	"constraints/invalid_constraints":               QueryConstraintsInvalidConstraints,
	"database/health":                               QueryDatabaseHealth,
	...
	"index_advisor/columns":                         QueryIndexAdvisorColumns,
	"index_advisor/indexes":                         QueryIndexAdvisorIndexes,
	"index_advisor/relations":                       QueryIndexAdvisorRelations,
	"index_advisor/workload":                        QueryIndexAdvisorWorkload,
	"index_advisor/writes":                          QueryIndexAdvisorWrites,
	...
	"settings/plan_log_settings":                    QuerySettingsPlanLogSettings,
