...
В таблице «Базы данных» по каждой базе собраны те же метрики, что и по инстансу: cache hit ratio, мёртвые версии строк, давность вакуума. Правила пересчитываются в контексте выбранной базы, а категории уровня инстанса при этом скрываются. Таблицу можно сортировать по размеру или по баллу, а выбранную базу — закрепить как контекст рекомендаций.
