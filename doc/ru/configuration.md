...
базовый интервал читал, либо p95 вырос вдвое и больше. Запрос, который встретился только в одном из
интервалов, в список не попадает. Длительности каждой стороны взяты у той структуры плана, на которую
