...
import WaitEventsSection from '@/components/home/WaitEventsSection.vue'
...
<template>
  ...
  <v-row class="mb-0">
    <v-col cols="12" md="6">
      <DatabaseHealthSection @error="onError" />
    </v-col>
    <v-col cols="12" md="6">
      <CacheHitRatesSection @error="onError" />
    </v-col>
  </v-row>
  <WaitEventsSection @error="onError" />
</template>
