...
const { items, loading } = useApiLoader<MaintenanceTransactionIdDanger[]>(
...
<template>
  <v-card class="mb-4">
    <v-card-title><v-icon start icon="mdi-alert-outline" />{{ t('maintenance.transactionIdDanger') }}</v-card-title>
    <v-card-text>
