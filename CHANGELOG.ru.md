...
- **Крошечная база больше не получает штраф за низкий cache hit ratio.** База из нескольких маленьких таблиц читает так мало блоков, что первые же холодные чтения роняют показатель; теперь он оценивается, только когда база прочитала достаточно, чтобы значение о чём-то говорило.
