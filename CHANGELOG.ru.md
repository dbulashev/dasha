...
### Багфиксы
- **Исправлен таймаут топа самых больших таблиц на базах с тысячами объектов.**
- **Исправлено пропадание таблиц выбранной базы из топа по размеру во время тяжёлых операций в других базах кластера.**
